...
export default function TestNoteEditorPage() {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <h1 className="text-2xl font-bold mb-6">Note Editor Test Page</h1>
      ...
      <div className="space-y-4">
        ...
        {selectedNote && (
          <div className="bg-blue-50 p-4 rounded">
            <h2 className="text-lg font-semibold mb-2">Note Editor Controls</h2>
